...
namespace Ananas
{
    public partial class Shoes : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string query = "SELECT masanpham, maloai, tensanpham, mota, gia, hinh, ngaytao FROM sanpham WHERE maloai in (1,2,3,4)";
        ...
        protected void DataListShoes_ItemDataBound(object sender, DataListItemEventArgs e)
        {
