<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Socks.aspx.cs" Inherits="Ananas.Socks" %>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        <div class="product-container">
            <asp:DataList ID="DataListSocks" runat="server" DataSourceID="SqlDataSourceSocks" 
                          RepeatColumns="3" RepeatDirection="Horizontal" class="product-list" 
                          OnItemDataBound="DataListSocks_ItemDataBound">
                <ItemTemplate>
 ...
 <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "~/ChonSanPham.aspx?MaSanPham=" + Eval("MaSanPham") %>' Text='<%# Eval("TenSanPham") %>' Font-Bold="True" Font-Italic="False" Font-Size="13pt" Font-Underline="False" ForeColor="Black"></asp:HyperLink>
        ...
        <asp:SqlDataSource ID="SqlDataSourceSocks" runat="server" 
...
WHERE 
    p.MaLoai = 6  -- Điều kiện lọc theo mã loại sản phẩm
    AND (
