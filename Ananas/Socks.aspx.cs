...
namespace Ananas
{
    public partial class Socks : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string query = "SELECT masanpham, maloai, tensanpham, mota, gia, hinh, ngaytao FROM sanpham WHERE maloai = 6";
        ...
        protected void DataListSocks_ItemDataBound(object sender, DataListItemEventArgs e)
        {
