<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Tote_Bag.aspx.cs" Inherits="Ananas.Tote_Bag" %>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        <div class="product-container">
            <asp:DataList ID="DataListTote" runat="server" DataSourceID="SqlDataSourceTote" 
                          RepeatColumns="3" RepeatDirection="Horizontal" class="product-list" 
                          OnItemDataBound="DataListTote_ItemDataBound">
                <ItemTemplate>
 ...
 <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "~/ChonSanPham.aspx?MaSanPham=" + Eval("MaSanPham") %>' Text='<%# Eval("TenSanPham") %>' Font-Bold="True" Font-Italic="False" Font-Size="13pt" Font-Underline="False" ForeColor="Black"></asp:HyperLink>
        ...
        <asp:SqlDataSource ID="SqlDataSourceTote" runat="server" 
    ...
    km.TenKhuyenMai,
    CASE 
        WHEN GETDATE() BETWEEN km.NgayBatDau AND km.NgayKetThuc
