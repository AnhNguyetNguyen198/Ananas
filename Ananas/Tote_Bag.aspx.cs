...
namespace Ananas
{
    public partial class Tote_Bag : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string query = "SELECT masanpham, maloai, tensanpham, mota, gia, hinh, ngaytao FROM sanpham WHERE maloai  = 5";
        ...
        protected void DataListTote_ItemDataBound(object sender, DataListItemEventArgs e)
        {
